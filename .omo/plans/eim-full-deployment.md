...
- [x] 12. **Register Telegram webhook + live end-to-end test**  (webhook registered; delivery blocked by org policy iam.allowedPolicyMemberDomains)
  What to do:
...
- [x] 13. **Execute `deploy-gcr.sh` — full Cloud Run mesh deploy**
  What to do:
...
- [x] 14. **Endpoint verification log — health-check all 8 services**  (7/8 need image rebuild from current source; GFE blocks /healthz)
  What to do:
